...
INNER JOIN subscription ON customer.id_customer = subscription.id_subscription
INNER JOIN product ON subscription.id_subscription = product.id_product 
INNER JOIN orders ON product.id_product = orders.id_order WHERE COUNT (id_order) = ! '1';
